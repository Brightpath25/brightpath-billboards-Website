...
export default function EventCard({ title, description, timeframe, href, subLinks }: EventCardProps) {
  return (
    <article className="group relative flex h-full flex-col overflow-hidden border-t border-white/15 bg-[#101210] p-7 transition-colors hover:border-[#e3b04b] sm:p-8">
