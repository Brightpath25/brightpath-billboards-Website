        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="order-1 lg:order-2">
            <div className="relative w-full bg-black-card/30 border border-gold-base/20 rounded-2xl overflow-hidden backdrop-blur-sm" style={{ height: '600px' }}>
              ...
              {/* 3D Controls */}
              <div className="absolute left-4 bottom-4 flex flex-wrap gap-3">
                <button
                  onClick={resetView}
                  className="flex items-center gap-2 px-4 py-2 bg-black-card/90 backdrop-blur-md hover:bg-black-card border border-gold-base/20 hover:border-gold-base/50 rounded-lg shadow-lg transition-all text-text-light text-sm font-medium"
                >
                  <RotateCcw className="h-4 w-4 text-gold-base" />
                  Reset View
                </button>
                <label className="inline-flex items-center gap-2 px-4 py-2 bg-black-card/90 backdrop-blur-md hover:bg-black-card border border-gold-base/20 hover:border-gold-base/50 rounded-lg shadow-lg cursor-pointer transition-all text-text-light text-sm font-medium">
                  <input
                    type="checkbox"
                    checked={autoRotate}
            ...
            <div className="mt-6 p-5 bg-gold-gradient rounded-xl text-black-hero text-center">
              <p className="text-sm font-semibold">
                <strong>Interactive 3D Model</strong> • Drag to rotate • Camera controls enabled
              </p>
            </div>
