...
export default function TargetedCampaignsPage() {
  ...
  return (
    <div className="service-page service-page--targeted min-h-screen bg-black-hero">
      {/* Hero Section */}
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="tel:7603858989" className="luxury-button text-lg bg-black-hero text-gold-base border-2 border-gold-base hover:bg-gold-base/10">
                Call (760) 385-8989
              </a>
            </div>
          </div>
