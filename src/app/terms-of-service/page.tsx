...
export const metadata: Metadata = {
  ...
  description: "BrightPath Billboards Terms of Service for BrightPath Billboards LLC and BrightPathIQ.",
};
...
export default function Page() {
  return <PolicyPage title="BrightPath Billboards Terms of Service" content={content} />;
}
